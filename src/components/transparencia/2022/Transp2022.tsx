      ...
      <section id="transparencia">
        ...
        <div className={style.sinconvinho}>
          <article className="portfolio__item">
            ...
            <h3 className="transparencia_h3">
              SICONVINHO - Sistema de Parcerias entre Prefeituras e Entidades
            </h3>
            <a
              href="https://www.lei13019.com.br/inicial.php?orgao_id=65&orgao_nome=Munic%C3%ADpio%20da%20Est%C3%A2ncia%20Tur%C3%ADstica%20de%20Paragua%C3%A7u%20Paulista&orgao_estado=SP&orgao_cidade=Paragua%C3%A7u%20Paulista&orgao_logomarca=jpg&pasta=sp/paraguacupaulista/"
              target="_blank"
              className="btn-transparencia"
            >
              Acesso ao Sistema
            </a>
          </article>
        ...
        <div className={style.transparencia__container}>
          <article className="portfolio__item">
            ...
            <h3 className="ata transparencia_h3">
              Ata de eleiçao gestão - 2021/2022
            </h3>
            <a href={ata} target="_blank" className="btn-transparencia">
              Abrir
            </a>
          </article>
          ...
          <article className="portfolio__item">
            <MdPictureAsPdf className="about__icon" />
            <h3 className="transparencia_h3">
              Relatório Fotografico | Relatório Anual de Atividades - 2021
            </h3>
            <a href={fotos} target="_blank" className="btn-transparencia">
              Fotos
            </a>
            <a href={atividades} target="_blank" className="btn-transparencia">
              Atividades
            </a>
          </article>
          ...
          <article className="portfolio__item">
            <MdPictureAsPdf className="about__icon" />
            <h3 className="transparencia_h3">
              Proposta e Plano de Trabalho 06/2022 TF 11/2022
            </h3>
            <a href={plano06} target="_blank" className="btn-transparencia">
              Abrir
            </a>
          </article>
          ...
          <article className="portfolio__item">
            <MdPictureAsPdf className="about__icon" />
            <h3 className="transparencia_h3">
              Proposta e Plano de Trabalho 07/2022 TF 12/2022
            </h3>
            <a href={plano07} target="_blank" className="btn-transparencia">
              Abrir
            </a>
          </article>
          ...
          <article className="portfolio__item">
            <MdPictureAsPdf className="about__icon" />
            <h3 className="transparencia_h3">
              Proposta e Plano de Trabalho 08/2022 TF 13/2022
            </h3>
            <a href={plano08} target="_blank" className="btn-transparencia">
              Abrir
            </a>
          </article>
          ...
          <article className="portfolio__item">
            <MdPictureAsPdf className="about__icon" />
            <h3 className="transparencia_h3">
              Proposta e Plano de Trabalho 22/2022 TF 20/2022
            </h3>
            <a href={proposta22} target="_blank" className="btn-transparencia">
              Abrir
            </a>
          </article>
          ...
          <article className="portfolio__item">
            <MdPictureAsPdf className="about__icon" />
            <h3 className="transparencia_h3">
              Proposta e Plano de Trabalho 23/2022 TF 14/2022
            </h3>
            <a href={proposta23} target="_blank" className="btn-transparencia">
              Abrir
            </a>
          </article>
          ...
          <article className="portfolio__item">
            ...
            <a href={sebas} target="_blank" className="btn-transparencia">
              Abrir
            </a>
            <a href={sebas1} target="_blank" className="btn-transparencia">
              Abrir
            </a>
          </article>
          ...
          <article className="portfolio__item">
            ...
            <a href={cnpj} target="_blank" className="btn-transparencia">
              Abrir
            </a>
          </article>
          ...
          <article className="portfolio__item">
            ...
            <a href={crce} target="_blank" className="btn-transparencia">
              Abrir
            </a>
          </article>
          ...
          <article className="portfolio__item">
            ...
            <a href={estatuto} target="_blank" className="btn-transparencia">
              Abrir
            </a>
          </article>
          ...
          <article className="portfolio__item">
            ...
            <a href={insc} target="_blank" className="btn-transparencia">
              Abrir
            </a>
          </article>
          ...
          <article className="portfolio__item">
            ...
            <a href={cmdca} target="_blank" className="btn-transparencia">
              Abrir
            </a>
          </article>
          ...
          <article className="portfolio__item">
            <MdPictureAsPdf className="about__icon" />
            <h3 className="ulti transparencia_h3">
              Utilidade Publica Municipal
            </h3>
            <a href={ultilidade} target="_blank" className="btn-transparencia">
              Abrir
            </a>
          </article>
          ...
          <article className="portfolio__item">
            <MdPictureAsPdf className="about__icon" />
            <h3 className="transparencia_h3">
              Certificado de Lincença do Corpo de Bombeiros
            </h3>
            <a href={bombeiro} target="_blank" className="btn-transparencia">
              Abrir
            </a>
          </article>
          ...
          <article className="portfolio__item">
            <MdPictureAsPdf className="about__icon" />
            <h3 className="transparencia_h3">
              Relação de Despesas - TF11 3º Quadrimestre - Federal
            </h3>
            <a href={tf11Rel} target="_blank" className="btn-transparencia">
              Abrir
            </a>
          </article>
          ...
          <article className="portfolio__item">
            <MdPictureAsPdf className="about__icon" />
            <h3 className="transparencia_h3">
              Relação de Despesas - TF12 3º Quadrimestre - Municipal
            </h3>
            <a href={tf12Rel} target="_blank" className="btn-transparencia">
              Abrir
            </a>
          </article>
          ...
          <article className="portfolio__item">
            <MdPictureAsPdf className="about__icon" />
            <h3 className="transparencia_h3">
              Relação de Despesas - TF13 3º Quadrimestre - Estadual
            </h3>
            <a href={tf13Rel} target="_blank" className="btn-transparencia">
              Abrir
            </a>
          </article>
          ...
          <article className="portfolio__item">
            <MdPictureAsPdf className="about__icon" />
            <h3 className="transparencia_h3">
              Relação de Despesas - TF14 Emendas Impositivas
            </h3>
            <a href={tf14Rel} target="_blank" className="btn-transparencia">
              Abrir
            </a>
          </article>
          ...
          <article className="portfolio__item">
            <MdPictureAsPdf className="about__icon" />
            <h3 className="transparencia_h3">
              Relação de Despesas - TF14 FMDCA
            </h3>
            <a href={tf28Rel} target="_blank" className="btn-transparencia">
              Abrir
            </a>
          </article>
          ...
          <article className="portfolio__item">
            <MdPictureAsPdf className="about__icon" />
            <h3 className="transparencia_h3">
              RP10 - Instalação de Sistema de Energia Fotovotaica - TF20 -
              MUNICIPAL - 2° Quadrimestre
            </h3>
            <a href={rp10inst} target="_blank" className="btn-transparencia">
              Abrir
            </a>
          </article>
          ...
          <article className="portfolio__item">
            <MdPictureAsPdf className="about__icon" />
            <h3 className="transparencia_h3">
              RP10 - TF11 1º Quadrimestre - Federal
            </h3>
            <a href={rp10tf11_1} target="_blank" className="btn-transparencia">
              Abrir
            </a>
          </article>
          ...
          <article className="portfolio__item">
            <MdPictureAsPdf className="about__icon" />
            <h3 className="transparencia_h3">
              RP10 - TF11 2º Quadrimestre - Federal
            </h3>
            <a href={rp10tf11_2} target="_blank" className="btn-transparencia">
              Abrir
            </a>
          </article>
          ...
          <article className="portfolio__item">
            <MdPictureAsPdf className="about__icon" />
            <h3 className="transparencia_h3">
              RP10 - TF11 3º Quadrimestre - Federal
            </h3>
            <a href={rp10tf11_3} target="_blank" className="btn-transparencia">
              Abrir
            </a>
          </article>
          ...
          <article className="portfolio__item">
            <MdPictureAsPdf className="about__icon" />
            <h3 className="transparencia_h3">
              RP10 - TF12 1º Quadrimestre - Municipal
            </h3>
            <a href={rp10tf12_1} target="_blank" className="btn-transparencia">
              Abrir
            </a>
          </article>
          ...
          <article className="portfolio__item">
            <MdPictureAsPdf className="about__icon" />
            <h3 className="transparencia_h3">
              RP10 - TF12 2º Quadrimestre - Municipal
            </h3>
            <a href={rp10tf12_2} target="_blank" className="btn-transparencia">
              Abrir
            </a>
          </article>
          ...
          <article className="portfolio__item">
            <MdPictureAsPdf className="about__icon" />
            <h3 className="transparencia_h3">
              RP10 - TF12 3º Quadrimestre - Municipal
            </h3>
            <a href={rp10tf12_3} target="_blank" className="btn-transparencia">
              Abrir
            </a>
          </article>
          ...
          <article className="portfolio__item">
            <MdPictureAsPdf className="about__icon" />
            <h3 className="transparencia_h3">
              RP10 - TF13 1º Quadrimestre - Estadual
            </h3>
            <a href={rp10tf13_1} target="_blank" className="btn-transparencia">
              Abrir
            </a>
          </article>
          ...
          <article className="portfolio__item">
            <MdPictureAsPdf className="about__icon" />
            <h3 className="transparencia_h3">
              RP10 - TF13 2º Quadrimestre - Estadual
            </h3>
            <a href={rp10tf13_2} target="_blank" className="btn-transparencia">
              Abrir
            </a>
          </article>
          ...
          <article className="portfolio__item">
            <MdPictureAsPdf className="about__icon" />
            <h3 className="transparencia_h3">
              RP10 - TF13 3º Quadrimestre - Estadual
            </h3>
            <a href={rp10tf13_3} target="_blank" className="btn-transparencia">
              Abrir
            </a>
          </article>
          ...
          <article className="portfolio__item">
            <MdPictureAsPdf className="about__icon" />
            <h3 className="transparencia_h3">
              RP10 - TF14 1º Quadrimestre - Emendas Impositivas
            </h3>
            <a href={rp10tf13_1} target="_blank" className="btn-transparencia">
              Abrir
            </a>
          ...
          <article className="portfolio__item">
            ...
            <a href={rp10tf14_1} target="_blank" className="btn-transparencia">
              Abrir
            </a>
          </article>
          ...
          <article className="portfolio__item">
            <MdPictureAsPdf className="about__icon" />
            <h3 className="transparencia_h3">
              RP10 - TF14 2º Quadrimestre - Emendas Impositivas
            </h3>
            <a href={rp10tf14_2} target="_blank" className="btn-transparencia">
              Abrir
            </a>
          </article>
          ...
          <article className="portfolio__item">
            <MdPictureAsPdf className="about__icon" />
            <h3 className="transparencia_h3">
              RP10 - TF14 3º Quadrimestre - Emendas Impositivas
            </h3>
            <a href={rp10tf14_3} target="_blank" className="btn-transparencia">
              Abrir
            </a>
          </article>
          ...
          <article className="portfolio__item">
            <MdPictureAsPdf className="about__icon" />
            <h3 className="transparencia_h3">
              RP10 - TF14 Anual - Emendas Impositivas
            </h3>
            <a
              href={rp10tf14Anual}
              target="_blank"
          ...
          <article className="portfolio__item">
            <MdPictureAsPdf className="about__icon" />
            <h3 className="transparencia_h3">
              RP10 - TF28 2º Quadrimestre - FMDCA
            </h3>
            <a href={rp10tf28_2} target="_blank" className="btn-transparencia">
              Abrir
            </a>
          </article>
          ...
          <article className="portfolio__item">
            <MdPictureAsPdf className="about__icon" />
            <h3 className="transparencia_h3">
              RP10 - TF28 3º Quadrimestre - FMDCA
            </h3>
            <a href={rp10tf28_3} target="_blank" className="btn-transparencia">
              Abrir
            </a>
          </article>
          ...
          <article className="portfolio__item">
            ...
            <a href={BALANCO} target="_blank" className="btn-transparencia">
              Abrir
            </a>
          </article>
        </div>
